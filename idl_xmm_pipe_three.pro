pro idl_xmm_pipe_three, other_args
...
hard_coded_dir = '/mnt/4tbdata/three'

; minimum size of good time intervals to be returned 
gpsz = 300.
...
; LOOP over the number of sources
   for k = 0, nsrcs-1 do begin
         ...
         ; Find the unique DETID for this source
         nwnum = 0L
...
; get detID into standard format of 6 digits. detID can be 4 or 5 digits 
        ...
        case length_convert_detid of
          1: convert_detid = '00000' + convert_detid
          2: convert_detid = '0000' + convert_detid
